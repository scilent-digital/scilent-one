 ...
 */
export function cssVar(property, value, fallback = '') {
 ...
 */
export function responsiveCSSVar(property, breakpoints, fallback = '') {
  const result = {};
 ...
 */
export function generateColorPalette(colorName, colorScale, opacity = 1) {
  const palette = {};
 ...
 */
export function componentStyles(options = {}) {
  const styles = {
    base: '',
    variants: {},
    ...options
