...
export const hoverUtilities = {
  '.hover-lift': {
    '&:hover': {
      ...
      boxShadow: shadowAnimations['hover-lift'],
    },
  },
  '.hover-scale': {
    '&:hover': {
  ...
  '.hover-glow': {
    '&:hover': {
      boxShadow: shadowAnimations.glow,
    },
  },
  '.hover-glow-success': {
    '&:hover': {
      boxShadow: shadowAnimations['glow-success'],
    },
  },
  '.hover-glow-warning': {
    '&:hover': {
      boxShadow: shadowAnimations['glow-warning'],
    },
  },
  '.hover-glow-error': {
    '&:hover': {
      boxShadow: shadowAnimations['glow-error'],
    },
  },
} as const;
...
export const gradientUtilities = {
  ...
  '.gradient-success': {
    background:
      'linear-gradient(135deg, var(--color-success-500) 0%, var(--color-success-600) 100%)',
  },
  '.gradient-warning': {
    background:
  ...
  '.gradient-error': {
    background:
      'linear-gradient(135deg, var(--color-error-500) 0%, var(--color-error-600) 100%)',
  },
  '.gradient-rainbow': {
